...
public class CleanlinessHelper {
    ...
    public static void alboe_mystic_armory$tooltipHelper(ItemStack stack, List<Text> tooltip) {
    ...
    @Environment(EnvType.CLIENT)
    private static void alboe_mystic_armory$addLangMultiline(List<Text> tooltip, String key, Style style) {
    ...
    public static float alboe_mystic_armory$calculateAttackSpeed(float desiredAttackSpeed) {
        return desiredAttackSpeed - 4.0F;
    }

    public static int alboe_mystic_armory$calculateAttackDamage(int desiredAttackDamage, ToolMaterial material) {
     ...
     */
    public static int alboe_mystic_armory$toDecimalColor(int red, int green, int blue) {
     ...
     */
    public static String alboe_mystic_armory$ticksToSeconds(float ticks) {
     ...
     */
    public static String alboe_mystic_armory$decimalToPercentage(float decimal) {
     ...
     */
    public static boolean alboe_mystic_armory$isHolding(LivingEntity entity, Item item, boolean isTwoHanded) {
     ...
     */
    public static boolean alboe_mystic_armory$isHolding(LivingEntity entity, ItemStack itemStack, boolean isTwoHanded) {
     ...
     */
    public static double alboe_mystic_armory$sinInterpol(float progress, double middle, double bound) {
    ...
    /*
    public static float alboe_mystic_armory$getScale(PlayerEntity player, float coefficient, @NotNull SpellSchool... schools) {
        if(player == null) {
            return 1f;
        }
