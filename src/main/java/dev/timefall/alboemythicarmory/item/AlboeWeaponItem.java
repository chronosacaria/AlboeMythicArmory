...
public class AlboeWeaponItem extends ToolItem implements Vanishable {

    private final float attackDamage;
    private final Multimap<EntityAttribute, EntityAttributeModifier> attributeModifiers;

    public AlboeWeaponItem(ToolMaterial material, int attackDamage, float attackSpeed, float attackRange, Settings settings) {
    ...
    public boolean canRepair(ItemStack stack, ItemStack ingredient) {
        if (ingredient.isOf(ItemRegistry.DIVINITY_SHRAPNEL.get()))
