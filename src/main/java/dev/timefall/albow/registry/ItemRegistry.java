...
import dev.timefall.albow.item.AlbowWeaponItem;
import dev.timefall.albow.item.DivinityShrapnelItem;
import dev.timefall.albow.item.material.AlbowToolMaterials;
...
public class ItemRegistry {
    ...
    public static final RegistrySupplier<Item> SUNWROUGHT_BLADE     = registerWeapon("sunwrought_blade",        AlbowToolMaterials.COPPER,  9,  0.9F,   2.7F, 1440);
    ...
    public static final RegistrySupplier<Item> CLOCKWORK_DAGGER     = registerWeapon("clockwork_dagger",        AlbowToolMaterials.COPPER,  6,  2.3F,   2.0F, 260);
    ...
    public static final RegistrySupplier<Item> CHITTERFANG          = registerWeapon("chitterfang",             AlbowToolMaterials.BONE,    6,  2.5F,   2.0F, 280);
    ...
    public static final RegistrySupplier<Item> BLAZETAIL_BLADE      = registerWeapon("blazetail_blade",         AlbowToolMaterials.COPPER,  4,  2.35F,  2.0F, 260);
    ...
    public static final RegistrySupplier<Item> SUNBREAKER_MAUL      = registerWeapon("sunbreaker_maul",         AlbowToolMaterials.COPPER,  10,  0.72F, 2.4F, 1680);
    ...
    protected static RegistrySupplier<Item> registerWeapon(String id, ToolMaterial toolMaterial, int attackDamage, float attackSpeed, float attackRange, int durability) {
        RegistrySupplier<Item> supplier = ITEM.register(id, () -> new AlbowWeaponItem(
                toolMaterial,
                CleanlinessHelper.albow$calculateAttackDamage(attackDamage, toolMaterial),
                CleanlinessHelper.albow$calculateAttackSpeed(attackSpeed),
                CleanlinessHelper.albow$calculateAttackRange(attackRange),
